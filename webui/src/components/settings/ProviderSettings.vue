...
<template>
        ...
        :render-tag="
          (a: any, b: any) =>
            h(
              ...
              {
                closable: true,
                onClose: () => addProviderForm.models.splice(b, 1),
              },
              { default: () => a.name },
            )
        "
  ...
  >
    <n-form label-placement="left">
      ...
      <n-form-item label="Top P">
        <n-input v-model:value="addModelForm.settings.top_p" type="number" />
      </n-form-item>
  ...
  <n-modal
    ...
    style="width: fit-content; min-width: 25em"
  >
    <n-form v-if="editProviderForm.provider" label-placement="left">
      <n-form-item label="类型">
        <SettingsInput
      ...
      <n-form-item label="名称">
        <SettingsInput
          :value="editProviderForm.provider!.name"
          @confirm="
            async (name) => {
              await api.updateProvider(editProviderForm.provider!.id!, {
                name: name,
              })
              editProviderForm.provider!.name = name
            }
          "
        />
      </n-form-item>
      <n-form-item label="描述">
        <SettingsInput
          :value="editProviderForm.provider!.description"
          @confirm="
            async (description) => {
              await api.updateProvider(editProviderForm.provider!.id!, {
                description: description,
              })
              editProviderForm.provider!.description = description
            }
          "
        />
      </n-form-item>
        ...
        <SettingsInput
          ...
          @confirm="
            async (url) => {
              ...
              editProviderForm.provider!.url = url
            }
          "
        />
      </n-form-item>
        ...
        <SettingsInput
          ...
          @confirm="
            async (apiKey) => {
              ...
              editProviderForm.provider!.apiKey = apiKey
            }
          "
        />
      </n-form-item>
      <n-form-item label="模型">
        <NDynamicTags
          ...
          :render-tag="
            (a: any, b: any) =>
              renderProviderModelsTag(a, b, editProviderEditModel)
          "
        >
          <template #trigger>
            <NButton
  ...
  <n-modal
    ...
    style="width: fit-content; min-width: 25em"
  >
    <n-form v-if="editModelForm.model" label-placement="left">
      <n-form-item label="名称">
        <SettingsInput
        ...
        <SettingsInput
          ...
          @confirm="
            async (modelName) => {
              ...
              editModelForm.model!.modelName = modelName
            }
          "
        />
      </n-form-item>
        ...
        <SettingsInput
          ...
          @confirm="
            async (description) => {
              ...
              editModelForm.model!.description = description
            }
          "
        />
      </n-form-item>
      ...
      <n-form-item label="Temperture">
        <SettingsNumberInput
          :value="editModelForm.model!.settings.temperture"
          @confirm="
            async (temperture) => {
              await api.updateModel(editModelForm.model!.id!, {
                settings: {
              ...
              editModelForm.model!.settings.temperture = temperture
            }
          "
        />
      </n-form-item>
      <n-form-item label="Top P">
        <SettingsNumberInput
          :value="editModelForm.model!.settings.top_p"
          @confirm="
            async (top_p) => {
              await api.updateModel(editModelForm.model!.id!, {
                settings: {
              ...
              editModelForm.model!.settings.top_p = top_p
            }
          "
        />
      </n-form-item>
        ...
        <SettingsNumberInput
          ...
          @confirm="
            async (max_tokens) => {
              ...
              editModelForm.model!.settings.max_tokens = max_tokens
            }
          "
        />
      </n-form-item>
